...
import { LogOut, Home, Package, Users, Settings, Tag, Table as TableIcon } from "lucide-react";
        ...
        <div className="flex-1 overflow-y-auto py-4">
          <nav className="px-4 space-y-1">
            {navLinks.map((item) => (
              ...
              >
                <item.icon className="mr-3 flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                {item.name}
              </NavLink>
            ))}
          </nav>
